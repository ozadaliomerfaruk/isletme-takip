-- Ürün bazlı alış/satış raporu RPC'si
-- Server-side aggregation: binlerce urun_hareketler satırı yerine
-- ürün başına tek satır döner → minimum egress
...
BEGIN
  ...
  GROUP BY u.id, u.name, u.birim, k.id, k.name
