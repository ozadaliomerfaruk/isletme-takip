-- Kategori raporunu ürün kategorisi eşlemesi ile güncelle
-- Ürün kategorileri (type='urun') gelir/gider kategorilerine eşlenebilir
-- Eşleme varsa raporda eşlenmiş kategori kullanılır, yoksa ürünün kendi kategorisi kullanılır
