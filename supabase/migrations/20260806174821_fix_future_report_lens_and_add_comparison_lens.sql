-- İleri tarihli gelir/gider işlemlerinin tarihini değiştirmeden değerleme
-- referansını Türkiye gününe sabitler. Karşılaştırma tarihsel mercekleri için
-- bütün dönemleri tek ağ isteğinde hesaplayan yeni, dar bir RPC ekler.
--
-- Geriye uyumluluk: mevcut RPC imzası ve JSON çıktısı korunur; yeni RPC additive'tir.
...
CREATE FUNCTION public.get_income_expense_comparison_lens_v1(
  p_isletme_id uuid,
