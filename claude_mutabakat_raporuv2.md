...
**Spec v1.1 · 05.07.2026 · İşletme Takip**
...
3. **Koruma testi (zorunlu):** bir düzeltme kaydı oluşturup şunları assert eden node testi yazılır — (a) cari bakiye değişti, (b) gelir-gider toplamı değişmedi, (c) kategori raporu değişmedi, (d) KDV toplamı değişmedi, (e) cari ekstre exportu kaydı içeriyor. Denetimde gözden kaçan her nokta bu testte kırmızı yakar; denetim listesine değil bu teste güvenilir.
...
- **Faz 1 (çekirdek doğruluk):** Bölüm 7 veri modeli (2 kolonluk additive migration) → §7.1 filtre kapsam denetimi + koruma testi → sınır kontrolü (2, zincir kapısı dahil) → Bölge A kilidi (4) → devir düzeltme kaydı (3) → T sabitleme akışı. Kabul: senaryolar 1–4, 9–11, 13.
